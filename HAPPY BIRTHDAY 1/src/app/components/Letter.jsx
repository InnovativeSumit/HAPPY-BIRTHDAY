...
export default function Letter() {
    ...
    const letterText = `Dear KAushik,

On this very special day, I want you to know how proud and grateful I am to have you as my friend. Your birthday isn’t just a celebration of another year – it’s a celebration of your hard work, passion, and the amazing journey you’re on as an engineer.

You have this incredible ability to dream big, solve problems, and create things that make the world a better place. Your dedication and determination inspire everyone around you, and I truly believe you will achieve every goal you set your heart on.

May this year bring you endless opportunities, success in all your projects, and the strength to turn your dreams into reality. The future is so bright because you’re building it with your brilliance.

Happy Birthday, my talented engineer friend! 🎂✨
Keep dreaming, keep building, and keep shining! 🚀
        ...
        >
            <div className="max-w-4xl w-full">
                ...
                >
                    ...
                    <p className="text-lg text-purple-300">Just for you Kaushik, on your special day 💌</p>
                </motion.div>
